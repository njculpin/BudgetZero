...
export default function AssetFileForm(props: AssetFileFormProps) {
  ...
  return (
    <div class="asset-files-form">
      ...
      {/* Auto-upload file input */}
      <div class="asset-form">
        <div class="form-field">
          <label for="asset-file-upload" class="form-field__label">
            Add Files
            <Show when={isUploading()}>
              <span class="form-field__uploading"> (Uploading...)</span>
            </Show>
          </label>
          <div class="upload-zone">
            ...
            <div class="upload-zone__text">
              ...
              <p class="upload-zone__secondary">PDF, STL, OBJ, ZIP, etc. up to 50MB • Auto-uploads on select</p>
            </div>
            <input
