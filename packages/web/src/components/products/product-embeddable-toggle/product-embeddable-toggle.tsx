...
import { LoadingButton, ErrorMessage, SuccessMessage } from '@/components/interactive';
        ...
        <div class="embeddable-toggle__royalty">
          <div class="embeddable-toggle__royalty-info">
            ...
            <p class="embeddable-toggle__royalty-description">
              Set how much you earn when this product is embedded in another product. This
              amount is added to the buyer's total when someone purchases a product that
              includes yours.
            </p>
          </div>
          ...
          <div class="embeddable-toggle__royalty-input">
            ...
            <p class="embeddable-toggle__royalty-input-hint">
              You'll earn ${royaltyDollars()} each time someone purchases a product
              containing this one
            </p>
          </div>
        </div>
