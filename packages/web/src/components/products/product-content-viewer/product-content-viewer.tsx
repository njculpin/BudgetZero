...
import type { ProductDocumentRelation } from '../product-content-manager/content-item/content-item';
import PurchaseActions from '../product-content-manager/purchase-actions/purchase-actions';
...
export interface ProductContentViewerProps {
  ...
  /**
   * The platform fee and the fee-inclusive total, from
   * `getProductPriceBreakdown` — the same figures checkout charges.
   *
   * Passed in rather than derived here: the sum of the items below is the
   * subtotal, and this component previously showed that under a "Total" label,
   * so a buyer met the fee for the first time on the payment page.
   */
