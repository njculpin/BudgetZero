...
import type { ProductFile, ProductComponent } from '@gameloopers/core/types';
  ...
  createEffect(() => {
    const reqs: Requirement[] = [
      ...
      },
      {
        ...
        description:
          'Products must include downloadable files or embed other products as components.',
        status:
      ...
      },
      {
        ...
        label: 'Price set',
        description:
          'Set a price for your product. You can offer it for free by setting the price to $0.',
      ...
      },
      {
        ...
        description:
          "If this product is embeddable, set the royalty rate you'll earn when others embed it.",
        status: props.isEmbeddable
          ? props.royaltyRate !== null && props.royaltyRate >= 0
            ? 'complete'
            : 'incomplete'
          : 'complete',
      ...
      },
      {
        ...
        label: 'Cover image',
        description:
          'A cover image makes your product stand out in the marketplace. (Recommended but not required)',
    ...
    <div class="publish-checklist">
      ...
      <div class="publish-checklist__progress">
        ...
        <span class="publish-checklist__progress-text">
          {requirements().filter((r) => r.isRequired && r.status === 'complete').length} /{' '}
          {requirements().filter((r) => r.isRequired).length} required items complete
        </span>
      </div>
            ...
            >
              ...
              >
                ...
                <span class="publish-checklist__label">
                  {req.label}
                  {!req.isRequired && (
                    <span class="publish-checklist__optional"> (Optional)</span>
                  )}
                </span>
                <span
              ...
              <Show when={expanded() === req.id}>
                <p class="publish-checklist__description">{req.description}</p>
              </Show>
            </li>
          )}
        </For>
