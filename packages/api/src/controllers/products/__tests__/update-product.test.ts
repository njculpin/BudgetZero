...
import { productsUpdateProductPut } from '@gameloopers/api/controllers/products/update-product';
...
describe('PUT /api/products/update-product', () => {
  ...
  describe('Product Updates', () => {
    ...
    it('should update product description', async () => {
      ...
      await productsUpdateProductPut(makeContext({ request: mockRequest }));
