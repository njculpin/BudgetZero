...
import { webhooksStripe } from '@gameloopers/api/controllers/webhooks/stripe';
...
import * as royalties from '@gameloopers/core/data-access/royalties';
import * as payouts from '@gameloopers/core/data-access/payouts';
import * as users from '@gameloopers/core/data-access/users';
import * as webhookEvents from '@gameloopers/core/data-access/webhook-events';
import * as email from '@gameloopers/core/email/purchase-confirmation';
import * as monitoring from '@gameloopers/core/monitoring';
import type { Sale, SaleItem, Product } from '@gameloopers/core/types';
...
vi.mock('@gameloopers/core/data-access/royalties');
vi.mock('@gameloopers/core/data-access/payouts');
vi.mock('@gameloopers/core/data-access/users');
vi.mock('@gameloopers/core/data-access/webhook-events');
vi.mock('@gameloopers/core/email/purchase-confirmation');
...
async function post(): Promise<Response> {
  // Stripe authenticates itself by signature, not by session, so this runs as
  // an anonymous caller.
  return await webhooksStripe(
    makeContext({
      userId: null,
