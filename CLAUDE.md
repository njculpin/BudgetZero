...
This is the codebase for **Workshop**, transitioning from a previous tabletop creator marketplace platform (detailed specs in README.md). The project appears to be in early stages, with basic Next.js structure and Supabase authentication setup.
...
Phase 6.
Design Principles - Projects can have design principles all contributors agree to. Dos and Dont rules for contributors.
Sync Blocks - Rule books can have blocks of text that can be duplicated in different parts of the rule book, these blocks when edited will update throughout the app
Delete and Archive projects - Users can delete or archive projects they are owners of

Phase 7
User Facing Analytics

Phase 8
Create a Printers Account
Integration to send orders to Printer
Payment systems "Buy models from this printer", "Buy book from this printer"... checkout in one cart
