...
export const CreateProfileSchema = z.object({
  ...
  creator_roles: z
    .array(CreatorRoleSchema)
    .min(1, "Select at least one creator role"),
...
export const CreateGameProjectSchema = z
  .object({
    ...
    play_time_minutes: z
      .number()
      .min(1, "Play time must be at least 1 minute")
      .optional(),
    complexity_rating: z
      .number()
      .min(1, "Complexity rating must be 1-5")
      .max(5, "Complexity rating must be 1-5")
      .optional(),
...
export const CreateCollaboratorInviteSchema = z.object({
  ...
  contribution_description: z
    .string()
    .max(500, "Contribution description too long")
    .optional(),
...
export const ProjectSearchSchema = z.object({
  ...
  sort_by: z
    .enum(["created_at", "updated_at", "title", "popularity"])
    .default("updated_at"),
...
export type CreateCollaboratorInviteFormData = z.infer<
  typeof CreateCollaboratorInviteSchema
>;
