...
export type NotificationType =
  ...
  | 'payout_completed'
  | 'payout_failed'
export type PermissionType = 'read' | 'write' | 'delete' | 'admin' | 'manage_collaborators' | 'manage_pricing'
...
export interface OrderRevenueSplit {
  ...
  order_id: string
  recipient_id: string
  split_type: 'platform_fee' | 'asset_royalty' | 'collaborator_share' | 'project_creator'
...
export interface Notification {
  ...
  title: string
  message: string | null
  resource_type: 'project' | 'asset' | 'order' | 'payout' | 'collaborator' | null
  resource_id: string | null
