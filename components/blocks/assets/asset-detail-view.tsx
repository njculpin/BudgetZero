...
export function AssetDetailView({
  ...
  const showEditableFields = isOwner && !viewAsCustomer;
        ...
        {isOwner && (
          <div className="mb-6 flex items-center justify-end">
            <div className="inline-flex items-center gap-2 rounded-lg border bg-background p-1">
              <Button
                type="button"
                variant={!viewAsCustomer ? "default" : "ghost"}
                size="sm"
                ...
                <>
                  ...
                  <div className="text-xs text-muted-foreground pt-2 border-t">
                    ...
                    {activeLicense.license_type === "commercial" && (
                      <p>
                        Payment required for commercial use. Contact creator for
                        pricing.
                      </p>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          0-50% of revenue when used in other projects. Set to 0
                          for free use.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Select an existing project or start a new one with this asset.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
              <li>Add this asset to your existing projects</li>
              <li>Create a new project with this asset</li>
              <li>Request permission to use this asset (if not owned by you)</li>
            </ul>
          </div>
          <DialogFooter>
            <Button
