...
import { ProposeCollaborationButton } from "@/components/collaboration/propose-collaboration-button";
...
export default async function IllustrationDetailPage({
  ...
  const ILLUSTRATION_TYPE_LABELS: Record<string, string> = {
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex gap-2">
                {isOwner ? (
                  ...
                  <>
                    {illustration.seeking_collaborators && user && (
                      <ProposeCollaborationButton
                        asset={{
                          id: illustration.id,
                          title: illustration.title,
                          asset_type: "illustration",
                          creator: {
                            id: illustration.creator.id,
                            full_name: illustration.creator.full_name ?? undefined,
                            username: illustration.creator.username ?? undefined,
                          },
                        }}
                      />
                    )}
              ...
              <Card className="border-blue-200 bg-blue-50">
                <CardContent className="py-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-blue-900">Seeking Collaborators</h4>
                      <p className="text-sm text-blue-700 mt-1">
                        This creator is open to collaborative projects with revenue sharing.
                        {user ? " Click 'Propose Collaboration' to get started!" : " Sign in to propose collaboration."}
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  {illustration.file_size_bytes && (
                    <div>
                      ...
                      <p className="font-semibold">
                        {(illustration.file_size_bytes / 1024 / 1024).toFixed(2)}{" "}
                        MB
                      </p>
                    </div>
                  )}
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="text-sm text-gray-700 space-y-2">
                    ...
                    <p className="whitespace-pre-wrap">{licenseTemplate.terms}</p>
                  </div>
            ...
            <CardContent>
              ...
              >
                <Avatar className="h-12 w-12">
                  <AvatarImage src={illustration.creator.avatar_url ?? undefined} />
                  <AvatarFallback>
